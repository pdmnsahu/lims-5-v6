  ...
  try {
    const samples = await sql`
      SELECT
        ...
        MAX(CASE WHEN td.name = 'Total Moisture (TM)'   THEN st.id::text     END) AS tm_test_id,
        ...
        MAX(CASE WHEN td.name = 'Moisture (ADB)'        THEN st.id::text     END) AS adb_moist_test_id,
        ...
        MAX(CASE WHEN td.name = 'Ash (ADB)'             THEN st.id::text     END) AS adb_ash_test_id,
        ...
        MAX(CASE WHEN td.name = 'Gross Calorific Value' THEN st.id::text     END) AS gcv_test_id,
        ...
        MAX(CASE WHEN td.name = 'Volatile Matter (ADB)' THEN st.id::text     END) AS adb_vm_test_id,
        ...
        MAX(CASE WHEN td.name = 'Moisture (EQ)'         THEN st.id::text     END) AS eq_moist_test_id,
